    ...
    const renderGameElements = async (data, mode = 'initial') => {
        ...
        */
        ...
        const attachDebugClick = (layer, data, type) => {
            debugHandler.attachDebugClick(layer, data, type);
        };
        ...
        _lineLayerMap = lineLayerMap;
        _circleLayerMap = circleLayerMap;
        _blueCircleLayerMap = blueCircleLayerMap;
        _greenCirclesByLine = greenCirclesByLine;
        _polygonState = polygonState;
