 ...
 * Создание Markdown и JSON отчётов для анализа кода
 */

const path = require('path');

/**
 * Рекурсивный вывод дерева вызовов
 ...
 * @param {Set} visited - посещённые узлы
